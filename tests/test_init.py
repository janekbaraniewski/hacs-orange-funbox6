"""Test funbox6 setup process."""
from homeassistant.exceptions import ConfigEntryNotReady
import pytest
from pytest_homeassistant_custom_component.common import MockConfigEntry

from custom_components.funbox6 import (
    BlueprintDataUpdateCoordinator,
    async_reload_entry,
    async_setup_entry,
    async_unload_entry,
)
from custom_components.funbox6.const import DOMAIN
...
async def test_setup_unload_and_reload_entry(hass, bypass_get_data):
    ...
    # call, no code from custom_components/funbox6/api.py actually runs.
