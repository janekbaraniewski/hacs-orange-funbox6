...
from custom_components.funbox6 import async_setup_entry
from custom_components.funbox6.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch(
        "custom_components.funbox6.IntegrationBlueprintApiClient.async_set_title"
    ) as title_func:
